    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Form Tambah Transaksi Rental</h5>
                                ...
                                <div class="col-sm-9">
                                    <select name="vehicle_id" id="vehicle_id" class="form-select @error('vehicle_id') is-invalid @enderror" required>
                                        ...
                                        @foreach ($vehicles as $vehicle)
                                            <option value="{{ $vehicle->id }}" data-price="{{ $vehicle->price_per_day }}" {{ old('vehicle_id') == $vehicle->id ? 'selected' : '' }}>
                                ...
                                <div class="col-sm-9">
                                    <select name="driver_id" id="driver_id" class="form-select @error('driver_id') is-invalid @enderror">
                                        ...
                                        @foreach ($drivers as $driver)
                                            <option value="{{ $driver->id }}" data-price="{{ $driver->cost_per_day }}" {{ old('driver_id') == $driver->id ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="alert alert-info">
                                        ...
                                        <p class="mb-0">Total Hari: <span id="preview_days" class="fw-bold">0</span> Hari</p>
                                        <p class="mb-0">Total Harga: <span id="preview_price" class="fw-bold">Rp 0</span></p>
                                    </div>
                                </div>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function calculateEstimate() {
                ...
                if (startDateInput.value && endDateInput.value && end >= start) {
                    ...
                    days = Math.ceil(diffTime / (1000 * 60 * 60 * 24)) + 1; // Termasuk hari H
            ...
            // Initial calculation if old inputs exist
            calculateEstimate();
        });
    </script>
    @endpush
