<x-app>
    ...
    <div class="card shadow-lg p-3">
        <form action="{{ route('vehicle.store') }}" method="post" enctype="multipart/form-data" class="form">
            @csrf
            <div class="row g-3 mb-3">
                <div class="col-md-3">
                    ...
                    <img src="{{ asset('niceadmin/img/noprofil.png') }}" alt="Image" class="w-100 rounded mt-2" id="preview">
                </div>
                <div class="col-md-9">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('brand') is-invalid @enderror" type="text" id="brand" name="brand" required value="{{ old('brand') }}">
                        @error('brand') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label for="license_plate" class="form-label required">Plat Nomor</label>
                        <input class="form-control @error('license_plate') is-invalid @enderror" type="text" id="license_plate" name="license_plate" required value="{{ old('license_plate') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('price_per_day') is-invalid @enderror" type="number" id="price_per_day" name="price_per_day" required value="{{ old('price_per_day') }}">
