<x-app>
    ...
    <div class="card shadow-lg p-3">
        <form action="{{ route('driver.store') }}" method="post" enctype="multipart/form-data" class="form">
            @csrf
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-9">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control @error('license_number') is-invalid @enderror" type="text" id="license_number" name="license_number" required value="{{ old('license_number') }}">
                        @error('license_number') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>
                    <div class="mb-3">
                        <label for="cost_per_day" class="form-label required">Biaya Jasa per Hari (Rp)</label>
                        <input class="form-control @error('cost_per_day') is-invalid @enderror" type="number" id="cost_per_day" name="cost_per_day" required value="{{ old('cost_per_day') }}">
